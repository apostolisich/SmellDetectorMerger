...
public class ShotgunSurgery extends Smell {
	...
	public ShotgunSurgery(String className, String methodName, IFile targetIFile, int targetStartLine) {
	...
	public String getSmellTypeName() {
		return SmellType.SHOTGUN_SURGERY.getName();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ShotgunSurgery other = (ShotgunSurgery) obj;
